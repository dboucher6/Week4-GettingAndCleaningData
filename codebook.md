...
The tidydata.txt file generated from run_analysis() in this project is a data frame of 180 observations and 81 variables. 

The 180 observations are all possible combinations of 30 subjects performing 6 activities:
LAYING
SITTING
STANDING
WALKING
...
The resulting 81 variables are the mean for each subject/Activity combination of the following movement measurements:
